...
class Music {
  public:
    ...
    static void music_qiu() { mciSendString("play qiu from 0", NULL, 0, NULL); }
    static void music_add2() { mciSendString("play add2 from 0", NULL, 0, NULL); }
    static void music_beadd() { mciSendString("play beadd from 0", NULL, 0, NULL); }
    static void music_again() { mciSendString("play again from 0", NULL, 0, NULL); }
    static void music_pick() { mciSendString("play pick from 0", NULL, 0, NULL); }
    static void music_play() { mciSendString("play play from 0", NULL, 0, NULL); }
    static void music_start() { mciSendString("play start from 0", NULL, 0, NULL); }
    ~Music() {
